...
namespace MedicalResearch.VisitData.StoreAccess {
  ...
  /// <summary> Provides CRUD access to stored DataRecordings (based on schema version '2.0.0') </summary>
  public partial interface IDataRecordingStore : System.Data.Fuse.IRepository<DataRecording, Guid> {
  }

  /// <summary> Provides CRUD access to stored Visits (based on schema version '2.0.0') </summary>
  public partial interface IVisitStore : System.Data.Fuse.IRepository<Visit, Guid> {
  }

  /// <summary> Provides CRUD access to stored DrugApplyments (based on schema version '2.0.0') </summary>
  public partial interface IDrugApplymentStore : System.Data.Fuse.IRepository<DrugApplyment, Guid> {
  }

  /// <summary> Provides CRUD access to stored StudyEvents (based on schema version '2.0.0') </summary>
  ...
  /// <summary> Provides CRUD access to stored Treatments (based on schema version '2.0.0') </summary>
